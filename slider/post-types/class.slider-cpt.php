    ...
    class Slider_Post_Type
    {
        ...
        public function create_post_type()
        {
            register_post_type(
                'slider',
                array(
                    'label' => esc_html__('Slider', 'slider'),
                    'description'   => esc_html__('Sliders', 'slider'),
                    'labels' => array(
                        'name'  => esc_html__('Sliders', 'slider'),
                        'singular_name' => esc_html__('Slider', 'slider'),
                    ),
                    'public'    => true,
        ...
        public function add_meta_boxes()
        {
            add_meta_box(
                'slider_meta_box',
                esc_html__('Link Options', 'slider'),
        ...
        public function save_post($post_id)
        {
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'editpost') {
                ...
                if (empty($new_link_text)) {
                    update_post_meta($post_id, 'slider_link_text', esc_html__('Add some text', 'slider'));
                } else {
